...
#define STR_MODULENAME "HDACodec Miniport: "
...
/*****************************************************************************
 * CMiniport::GetDescription
 *****************************************************************************
 * Gets the topology.
 */
STDMETHODIMP_(NTSTATUS) CMiniport::GetDescription
(
...
)
{
    ...
    DOUT (DBG_PRINT, ("[CMiniport::GetDescription]"));
 ...
 * CMiniport::DataRangeIntersection
 *****************************************************************************
...
STDMETHODIMP_(NTSTATUS) CMiniport::DataRangeIntersection
(
         ULONG           PinId,
...
)
{
    ...
    DOUT (DBG_PRINT, ("[CMiniport::DataRangeIntersection]"));
 ...
 * specification.
 */
NTSTATUS CMiniport::TestDataFormat
(
 ...
 */
STDMETHODIMP_(void) CMiniport::PowerChangeNotify
(
...
)
{
    ...
    DOUT (DBG_PRINT, ("[CMiniport::PowerChangeNotify]"));
 ...
 */
STDMETHODIMP_(NTSTATUS) CMiniport::Init
(
