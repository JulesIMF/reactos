...
/* Verb Helper Macro */
#define MAKE_VERB(cad, nid, vid, payload) (((cad) << 28) | ((nid) << 20) | (vid) | (payload))
...
/* Connection list */
#define CONNECTION_LIST_ACTUAL(c) ((c) & 0x7f)
#define CONNECTION_LIST_IS_LONG(c) (!!((c) >> 7))
#define CONNECTION_LIST_ENTRY_SHORT(a, i) ((UINT8)(a >> (8 * (i))))
#define CONNECTION_LIST_ENTRY_LONG(a, i) ((USHORT)(a >> (16 * (i))))
#define CONNECTION_LIST_ENTRY_SHORT_IS_RANGE (1 << 7)
#define CONNECTION_LIST_ENTRY_LONG_IS_RANGE (1 << 15)
#define CONNECTION_LIST_ENTRY_SHORT_VALUE(a) ((a) & ~(CONNECTION_LIST_ENTRY_SHORT_IS_RANGE))
#define CONNECTION_LIST_ENTRY_LONG_VALUE(a) ((a) & ~(CONNECTION_LIST_ENTRY_LONG_IS_RANGE))
...
#define SUB_NODE_COUNT_TOTAL(c) ((c & SUB_NODE_COUNT_TOTAL_MASK) >> SUB_NODE_COUNT_TOTAL_SHIFT)
#define SUB_NODE_COUNT_START(c) ((c & SUB_NODE_COUNT_START_MASK) >> SUB_NODE_COUNT_START_SHIFT)
...
#define AUDIO_GROUP_CAP_OUTPUT_DELAY(c) ((c & AUDIO_GROUP_CAP_OUTPUT_DELAY_MASK) >> AUDIO_GROUP_CAP_OUTPUT_DELAY_SHIFT)
#define AUDIO_GROUP_CAP_INPUT_DELAY(c) ((c & AUDIO_GROUP_CAP_INPUT_DELAY_MASK) >> AUDIO_GROUP_CAP_INPUT_DELAY_SHIFT)
#define AUDIO_GROUP_CAP_BEEPGEN(c) ((c & AUDIO_GROUP_CAP_BEEPGEN_MASK) >> AUDIO_GROUP_CAP_BEEPGEN_SHIFT)
...
#define AUDIO_CAP_CHANNEL_COUNT(c)                                                                                     \
    (((c & AUDIO_CAP_CHANNEL_COUNT_MASK) >> (AUDIO_CAP_CHANNEL_COUNT_SHIFT - 1)) | AUDIO_CAP_STEREO)

#define AUDIO_CAP_DELAY(c) ((c & AUDIO_CAP_DELAY_MASK) >> (AUDIO_CAP_DELAY_SHIFT))

#define AUDIO_CAP_TYPE(c) ((c & AUDIO_CAP_TYPE_MASK) >> (AUDIO_CAP_TYPE_SHIFT))
...
#define AMP_CAP_STEP_SIZE(c) ((((c & AMP_CAP_STEP_SIZE_MASK) >> AMP_CAP_STEP_SIZE_SHIFT) + 1) / 4.0)
#define AMP_CAP_NUM_STEPS(c) ((c & AMP_CAP_NUM_STEPS_MASK) >> AMP_CAP_NUM_STEPS_SHIFT)
